...
test.describe('Button tests',() => {
    test('This test is the info component', async ({ page }) => {
        await page.goto(homePage);
...
test.describe('Footer tests', () => {
    test('Should containa footer on the home page', async ({ page }) => {
        await page.goto(homePage);
        await expect(page.locator('footer')).toContainText('In Class Example#1')
    })
})

test.describe('Check About page navigate to home page test', () => {
